...
num <- read.csv("R_sample/numOfPatchsets_2_Start10000-End70705_RQ2.csv"
                 ,sep=",", header=TRUE)
...
index_l_m <- list(data.frame(), data.frame())
index_d_m <- list(data.frame(), data.frame())
index_l_a <- list(data.frame(), data.frame())
index_d_a <- list(data.frame(), data.frame())
